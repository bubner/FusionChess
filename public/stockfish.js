...
function Xa(){return va||!ka&&!n||"function"!==typeof fetch?Promise.resolve().then(function(){return Wa()}):fetch(S,{credentials:"same-origin"}).then(function(a){if(!a.ok)throw"failed to load wasm binary file at '"+S+"'";return a.arrayBuffer()}).catch(function(){return Wa()})}var Ya={28285:function(){throw"Canceled!";}};
...
else if(z)postMessage({targetThread:a,cmd:"processThreadQueue"});else{a=(a=l.wa[a])&&a.worker;if(!a)return;a.postMessage({cmd:"processThreadQueue"})}return 1},b:Ab,C:function(a,b){if(0===a)a=Date.now();else if(1===a||4===a)a=ob();else return M[Ic()>>2]=28,-1;M[b>>2]=a/1E3|0;M[b+4>>2]=a%1E3*1E6|0;return 0},m:function(a,b,c){Bb.length=0;var e;for(c>>=2;e=I[b++];)(e=105>e)&&c&1&&c++,Bb.push(e?Ja[c++>>1]:M[c]),++c;return Ya[a].apply(null,Bb)},D:rb,l:function(){},p:Cb,d:qb,e:$a,f:ob,s:function(a,b,c){I.copyWithin(a,
